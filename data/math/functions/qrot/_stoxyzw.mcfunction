...
#输出：math:io xyzw,<qrot_x,int>,<qrot_y,int>,<qrot_z,int>,<qrot_w,int>
#需要传入math_marker为执行者
...
execute store result storage math:io xyzw[0] float 0.00000001 run scoreboard players operation qrot_x int += stempj0 int
execute store result storage math:io xyzw[1] float 0.00000001 run scoreboard players operation qrot_y int += stempj1 int
execute store result storage math:io xyzw[2] float 0.00000001 run scoreboard players operation qrot_z int += stempj2 int
execute store result storage math:io xyzw[3] float 0.00000001 run scoreboard players operation qrot_w int += stempj3 int

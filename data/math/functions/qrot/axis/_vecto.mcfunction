...
#j向量
scoreboard players operation qrot_j3 int = 3vec_x int
...
scoreboard players operation qrot_j0 int = 3vec_x int
scoreboard players operation qrot_j0 int *= qrot_cbeta int
scoreboard players operation qrot_j1 int = 3vec_y int
scoreboard players operation qrot_j1 int *= qrot_cbeta int
scoreboard players operation qrot_j2 int = 3vec_z int

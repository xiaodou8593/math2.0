...
scoreboard players operation qrot_x int *= sstemp_c1 int
scoreboard players operation qrot_y int *= sstemp_s1 int
scoreboard players operation qrot_z int *= sstemp_s1 int
scoreboard players operation qrot_w int *= sstemp_c1 int

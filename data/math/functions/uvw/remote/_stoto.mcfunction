#math:uvw/remote/_stoto
#输入storage math:io input，输出{<u,int>,<v,int>,<w,int>}
execute store result score sstempx1 int run data get storage math:io input[0] 10000
execute store result score sstempy1 int run data get storage math:io input[1] 10000
execute store result score sstempz1 int run data get storage math:io input[2] 10000
